...
OUT = ROOT / "presentation_visuals" / "model_label_examples"
...
def plot_selected_examples() -> None:
    ...
    notes.write_text(
        ...
        "Each type has two held-out examples: one with strong pixel-level overlap, "
        "and one where the patch is detected but the individual predicted pixels are messy.\n\n"

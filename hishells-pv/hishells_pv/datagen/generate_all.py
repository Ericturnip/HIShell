...
def main(argv: list[str] | None = None) -> None:
    ...
    out_root = (args.out_root or args.root / "pv_shells" / "training_data").resolve()
    ...
    for item in manifest:
        ...
        print(f"\n[batch] === {name} ===")
        try:
            run_module("hishells_pv.pv.make_pv", cfg_path, args.root / "pv_shells")
            run_module("hishells_pv.pv.label_pv", cfg_path, args.root / "pv_shells")
